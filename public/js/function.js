 ...
 function mainAnimation() {
   ...
   tw.staggerTo($('.main-txt .perspective-ani span'), .8, {
     rotationY: '0deg',
     alpha: 1,
     ease: Power1.easeOut,
     delay: 1
